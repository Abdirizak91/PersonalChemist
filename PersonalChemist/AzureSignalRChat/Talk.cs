...
namespace AzureSignalRChat
{
    public static class Talk
    {
        ...
        public static async Task<IActionResult> Run(
            ...
            [SignalR(HubName = "simplechat")] IAsyncCollector<SignalRMessage> questionR, ILogger log)
        {
            ...
            try
            {
                ...
                // log.LogInformation(jObject["ConnectionID"].ToString());  This is how to log into azure functions 
                await questionR.AddAsync(
                    new SignalRMessage
                    {
                        ConnectionId = jObject["ConnectionID"].ToString(),
